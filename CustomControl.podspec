...
Pod::Spec.new do |s|
  ...
  s.homepage     = "http://git.sys.cigna.com/ios/core"
  ...
  s.source       = { :git => "git@git.sys.cigna.com:ios/core.git", :tag => "1.1.4" }
  ...
  #
	s.prefix_header_file = "CignaCore/CignaCore-Prefix.pch"
	s.source_files = "CignaCore/**/*.{h,m}"
  ...
  #
  s.ios.resource_bundle = { 'CignaCoreBundle' => "CignaCore/**/*.{xib,png}" }

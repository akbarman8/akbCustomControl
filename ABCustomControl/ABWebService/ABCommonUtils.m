...
//--------------------------------------------------------------------------------------------------
+ (void)initialize {
    NSString *appName = [[[NSBundle mainBundleCore] infoDictionary] objectForKey:@"CFBundleName"];
...
+ (UIView *)backgroundView:(NSString *)imagename {
    ...
    UIImageView *imageviw = [[UIImageView alloc] initWithImage:[ABCommonUtils imageNamed:imagename]];
    return imageviw;
}
